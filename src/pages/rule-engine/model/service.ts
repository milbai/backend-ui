...
export async function list(params?: any) {
    return request(`/rwslinks/rule-engine/model/_query`, {
        method: 'GET',
        params: params,
    });
}
...
export async function listNoPaging(params?: any) {
    return request(`/rwslinks/rule-engine/model/_query/no-paging`, {
        method: 'GET',
        params: params,
    });
}
...
export async function info(id: string) {
    return request(`/rwslinks/rule-engine/model/${id}`, {
        method: 'GET',
    });
}
...
export async function deploy(id: string) {
    return request(`/rwslinks/rule-engine/model/${id}/_deploy`, {
        method: 'POST'
    })
}
...
export async function list(params: any) {
  return request(`/rwslinks/firmware/_query`, {
    method: 'GET',
    params: params,
  });
}
...
export async function remove(id: string) {
  return request(`/rwslinks/firmware/${id}`, {
    method: 'DELETE',
  });
}

export async function saveOrUpdate(params: Partial<FirmwareData>) {
  return request(`/rwslinks/firmware`, {
    method: 'PATCH',
    data: params,
  });
}
...
export async function _deployAll(id?: string) {
  return request(`/rwslinks/firmware/upgrade/task/${id}/all/_deploy`, {
    method: 'POST',
  });
}

export async function _deploy(idList: any[], id?: string) {
  return request(`/rwslinks/firmware/upgrade/task/${id}/_deploy`, {
    method: 'POST',
    data: idList,
  });
}
...
export async function upgradeTask(params: any) {
  return request(`/rwslinks/firmware/upgrade/task/_query`, {
    method: 'GET',
    params: params,
  });
}
...
export async function saveUpgrade(params: Partial<UpgradeTaskData>) {
  return request(`/rwslinks/firmware/upgrade/task`, {
    method: 'POST',
    data: params,
  });
}
...
export async function removeUpgrade(id: string) {
  return request(`/rwslinks/firmware/upgrade/task/${id}`, {
    method: 'DELETE',
  });
}

export async function upgradeHistory(params: any) {
  return request(`/rwslinks/firmware/upgrade/history/_query`, {
    method: 'GET',
    params: params,
  });
}
...
export async function removeUpgradeHistory(id: string) {
  return request(`/rwslinks/firmware/upgrade/history/${id}`, {
    method: 'DELETE',
  });
}

export async function _count(params: any) {
  return request(`/rwslinks/firmware/upgrade/history/_count`, {
    method: 'GET',
    params: params,
  });
}

...
class h264Demuxer {
  constructor(media, type) {
    ...
    this.mediaplay = new MediaPlay(this.media, this.type);
    this.remuxer = new MP4Remuxer(this.id,  this.media, this.mediaplay);
  ...
  setstatuscb(statuscb, user) {
        this.mediaplay.setstatuscb(statuscb, user);
  }

  setplaytimecb(playtimecb, user) {
      this.mediaplay.setplaytimecb(playtimecb, user);
  }
      ...
      switch(unit.type) {
        ...
        case 7:
          ...
          if(!track.sps) {
            ...
            this.mediaplay.onBufferReset({  mimeType:  track.codec });
            push = true;
          }
          break;
        //PPS

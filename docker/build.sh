#!/usr/bin/env bash
#docker build -t registry.cn-shenzhen.aliyuncs.com/rwslinks/rwslinks-ui-antd:1.0-SNAPSHOT .
#docker push registry.cn-shenzhen.aliyuncs.com/rwslinks/rwslinks-ui-antd:1.0-SNAPSHOT
